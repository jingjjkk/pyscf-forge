...
def main(traj_idx):
    ...
    # 1. 定义分子 (这部分不变)
    atom ='''
N   0.005067  -0.344384  -0.000463   
N   1.243139  -0.345229  -0.000145   
C  -0.738479   0.928476   0.000360   
C   1.988559   0.926735   0.000421   
H  -0.501791   1.536289   0.891600    
H  -0.502594   1.536700  -0.890838   
H  -1.811172   0.696958   0.000739   
H   1.752036   1.535663   0.890924   
H   1.754286   1.534562  -0.891466   
H   3.060873   0.693614   0.001802   
'''
    print("--- Calculating S0 Ground State Properties for Sampling ---")
    # 使用 RKS (自旋=0) 来描述 S0 基态
    mol = pyscf.M(atom=atom, basis='def2-svp', unit='A', spin=0)
    ...
    mol_t1 = pyscf.M(atom=sampled_atom_string, basis='def2-svp', unit='A', spin=2)
